...
## Introduction
The largest snowdrifts we have measured during four decades of Arctic snow research were 15 m deep and several kilometres long. Studies (Benson and Sturm, 1993; Sturm et al., 199_; Sturm and Stuefer, 2013) confirm that these large drifts form every winter, and summer satellite imagery (REF) provides evidence that due to their size, they rarely melt away before July. So for two-thirds of the year, where these drifts lie on land, they are perhaps best though of as the landscape, rather than just part of the seasonal snowpack. Outside of the Arctic, in the prairies and Rocky Mountains of the American West (Matthes, 1900), in the European Alps (Fohn and Meister, 1983), and elsewhere, drifts of similar size and duration are also found. In this paper, we examine Arctic drifts as landscape features and explore their geometry and distribution. In particular, we examine the persistence of these landscape features from one year to the next, discuss why they exhibit such strong annual fidelity, and how they relate to the underlying (greener) landscape.

These large drifts create distinctive snow patterns on a landscape through the spatial arrangements of two snow elements (or facies): **snow dirfts**, which are the "sinks" for windblown snow, and **scour zones**, which are the sources of the snow that create the drifts. These patterns are important because drifts provide runoff int he summer long after the rest of the snow cover is gone. On the tundra, this delayed runoff occurs when the seasonally frozen ground has thawd, allowing meltwater to infiltrate the soil. Drifts also increase the overall amount of water stored across a landscape because once stockpiled in a drift, snow is removed from the transport system and protected from the high sublimation rates that accompany blowing snow (e.g. up to 47% of the annual snowfall is lost to sublimation (Essery et al., 1999; see also Pomeroy et al., 1997; Liston and Sturm, 1998)). Recent work in the Himalaya (Stigter et al., 2018) indicates a strong anti-correlation between the spatial distribution of sublimation intensity and the distribution of drifts.
