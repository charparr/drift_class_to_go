...
##### CULL BELOW FIGURE? As the slopes of the lines do not show a significant difference between CLPX and HV and is redundant given Fig. 7.
...
###### *Figure 9: Six classes of snowdrift. Red polygons are the manual delineation of the drift features.*
...
The last class, "other" (Figure 9f) were those drifts from the sample set that had no obvious topographic association. These were most often found on hillslopes with mild grades of only a few degrees and formed irregularly-shaped patches, suggesting that perhaps some subtle upwind topographic feature had created enough flow separation to trigger snow deposition.

**Connectivity? Number of Pixels? Linearity vs. Compactness Measures?**

###### Table 4: Mean Drift Class Statistics by Swath.

| Swath | Class | Drift Area m<sup>2</sup> | Mean Depth m |https://news.ycombinator.com/ Drift Volume m<sup>3</sup> | Std. Depth m | CV Depth | NDV m |
|:-----:|:---------------:|:----------------:|:--------------:|:------------------:|:--------------:|:--------:|:-------:|
